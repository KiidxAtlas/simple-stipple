...
class RoundedRectangleShape(RectangleShape):
    ...
    def _compute_tessellation(self) -> list[Point]:
        from src.backend.cad.geometry import build_rounded_rect_poly
...
class StarShape(Shape):
    ...
    def _compute_tessellation(self) -> list[Point]:
        from src.backend.cad.geometry import build_star_poly
...
class SlotShape(Shape):
    ...
    def _compute_tessellation(self) -> list[Point]:
        from src.backend.cad.geometry import shape_slot
