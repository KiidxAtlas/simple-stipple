...
from src.backend.cad.editor_geometry import CanvasGeometry
...
from src.backend.editing.merge_explode import PathInput
from src.backend.editing.split import SplitResult
...
class GeometryService:
    ...
    def geometry_for_entity(entity) -> CanvasGeometry:
        from src.backend.cad.editor_geometry import CanvasGeometry as _CG
        from src.backend.cad.editor_geometry import (
    ...
    def shape_for_entity(entity) -> Shape:
        ...
        from src.backend.cad.shapes import Shape as _Shape
    ...
    def offset_polyline(
        ...
        from src.backend.editing.offset import offset_polyline as _offset

        return _offset(list(points), amount)

    @staticmethod
    def is_closed(points: Sequence[PointTuple], *, tolerance: float = 0.01) -> bool:
        from src.backend.editing.offset import is_closed as _is_closed
    ...
    def mirror_points(
        ...
        from src.backend.editing.transform import mirror as _mirror
    ...
    def rotate_points(
        ...
        from src.backend.editing.transform import rotate as _rotate
    ...
    def scale_points(
        ...
        from src.backend.editing.transform import scale as _scale
    ...
    def translate_points(
        ...
        from src.backend.editing.transform import translate as _translate
    ...
    def translate_entities(
        ...
        from src.backend.editing.transform import (
    ...
    def split_paths(
        ...
        from src.backend.editing.split import (
    ...
    def boolean_polylines(
        ...
        from src.backend.editing.boolean import (
    ...
    def resample_by_count(
        ...
        from src.backend.editing.resample import (
    ...
    def merge_paths(
        ...
        *,
        ...
        from src.backend.editing.merge_explode import (
            PathInput,
        )
        from src.backend.editing.merge_explode import (
            merge_paths as _mp,
    ...
    @staticmethod
    def analyze_geometry(polys: list[list[PointTuple]]) -> dict:
        """Re-export preflight analysis when available."""
        try:
            from src.backend.cad.preflight import (
                analyze_geometry as _analyze,
            )
        except ImportError:
            return {}
        result = _analyze(polys)
        return {
            "paths": result.paths,
            ...
            "zero_segments": result.zero_segments,
            "tiny_paths": result.tiny_paths,
            "minimum_segment": result.minimum_segment,
            "tolerance": result.tolerance,
            "near_closed": result.near_closed,
            "ready": result.ready,
