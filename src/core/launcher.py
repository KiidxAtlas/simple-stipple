...
from src.core.paths import user_log_dir, user_runtime_dir
...
def main(argv: list[str] | None = None) -> int:
    ...
    from src.core.paths import user_cache_dir
    ...
    from src.core.error_reporting import init_sentry_full, install_excepthook, install_toast
