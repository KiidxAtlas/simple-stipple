"""Core storage helpers — file I/O and atomic writes.

These are framework-agnostic utilities used by settings, workspace loading,
and DXF export.  No layer may depend on ``backend.persistence`` for these;
they live here because they are pure I/O with no CAD-domain knowledge.
"""
