...
from simple_stipple.engine.formats.dxf_fix import FixMode
from simple_stipple.engine.formats.dxf_fix import fix_dxf as _fix_dxf
...
class DxfService:
    ...
    def write_polylines_svg(
        ...
        return _write_polylines_svg([list(p) for p in polylines], filepath)
    ...
    def write_fvi(
        ...
        return _write_fvi(data, filepath, options)
