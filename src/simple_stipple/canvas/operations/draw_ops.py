...
from simple_stipple.engine.cad.constraints import (
    ConstraintKind,
    GeometricConstraint,
    solve_constraints,
)
...
from simple_stipple.platform.config import normalize_draw_sidebar_shape_tools
...
class ConstructionService:
    ...
    def create_angle_bisector(self) -> int:
        from simple_stipple.engine.cad.construction import angle_bisector
    ...
    def create_centerline(self) -> int:
        from simple_stipple.engine.cad.construction import centerline
    ...
    def create_circle_through_three_points(self) -> int:
        from simple_stipple.engine.cad.construction import circumcircle
    ...
    def create_tangents_from_point(self) -> int:
        from simple_stipple.engine.cad.construction import tangents_from_point
    ...
    def create_common_circle_tangents(self) -> int:
        from simple_stipple.engine.cad.construction import common_circle_tangents
