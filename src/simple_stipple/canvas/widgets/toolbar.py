...
class ResponsiveCanvasToolbar(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self._overflow.hide()
        self._guidance_chip = _ElidingLabel("")
        self._guidance_chip.setMinimumWidth(0)
        self._guidance_chip.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Preferred)
