...
_CONTEXT_ACTION_LABELS.update(
    {
        ...
        "context.arrange.center": "Center on selection (both axes)",
        ...
        "context.arrange.distribute_horizontal_even": "Distribute horizontal — evenly over…",
        "context.arrange.distribute_vertical_even": "Distribute vertical — evenly over…",
