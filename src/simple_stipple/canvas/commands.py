...
COMMANDS: tuple[Command, ...] = (
    ...
    Command(
        ...
        "Horizontal",
        lambda v: v._construction_service.add_geometric_constraint("horizontal"),
        category="Constraints",
    ),
    Command(
        "constraint.vertical",
        "Vertical",
        lambda v: v._construction_service.add_geometric_constraint("vertical"),
        category="Constraints",
    ),
    Command(
        "constraint.parallel",
        "Parallel",
        lambda v: v._construction_service.add_geometric_constraint("parallel"),
        category="Constraints",
    ),
    Command(
        "constraint.perpendicular",
        "Perpendicular",
        lambda v: v._construction_service.add_geometric_constraint("perpendicular"),
        category="Constraints",
    ),
    Command(
        "constraint.equal",
        "Equal",
        lambda v: v._construction_service.add_geometric_constraint("equal"),
        category="Constraints",
    ),
    Command(
    ...
    Command(
        ...
        "Coincident",
        lambda v: v._construction_service.add_geometric_constraint("coincident"),
        category="Constraints",
    ),
    Command(
        "constraint.fixed",
        "Fixed",
        lambda v: v._construction_service.add_geometric_constraint("fixed"),
        category="Constraints",
    ),
    Command(
        "constraint.collinear",
        "Collinear",
        lambda v: v._construction_service.add_geometric_constraint("collinear"),
        category="Constraints",
    ),
    Command(
        "constraint.concentric",
        "Concentric",
        lambda v: v._construction_service.add_geometric_constraint("concentric"),
        category="Constraints",
    ),
    Command(
        "constraint.tangent",
        "Tangent",
        lambda v: v._construction_service.add_geometric_constraint("tangent"),
        category="Constraints",
    ),
    Command(
        "constraint.smooth",
        "Smooth (G2)",
        lambda v: v._construction_service.add_geometric_constraint("smooth"),
        category="Constraints",
    ),
    Command(
        "constraint.symmetric",
        "Symmetric",
        lambda v: v._construction_service.add_geometric_constraint("symmetric"),
        category="Constraints",
    ),
    Command(
        "constraint.midpoint",
        "Midpoint",
        lambda v: v._construction_service.add_geometric_constraint("midpoint"),
        category="Constraints",
    ),
    Command(
        "constraint.intersection",
        "Intersection",
        lambda v: v._construction_service.add_geometric_constraint("intersection"),
        category="Constraints",
    ),
    Command(
        "constraint.projection",
        "Project as Construction",
        lambda v: v._construction_service.add_geometric_constraint("projection"),
        category="Constraints",
    ),
    Command(
        "constraint.unfix",
        "Unfix",
        lambda v: v._construction_service.add_geometric_constraint("unfix"),
        category="Constraints",
    ),
    Command(
        "constraint.remove",
        "Remove Constraints",
        lambda v: v._construction_service.remove_constraints_for_selection(),
        category="Constraints",
    ),
    # ── Path ────────────────────────────────────────────────────────────────
    Command(
