...
from src.backend.geometry import arc_from_center_start_end, arc_from_three_points
...
def start_bezier_handle_drag(v: PolylineView, hit: tuple[int, int, str]) -> bool:
...
def apply_bezier_handle_drag(v: PolylineView, event: QMouseEvent) -> bool:
...
def release_bezier_handle_drag(v: PolylineView) -> None:
