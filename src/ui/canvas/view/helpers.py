...
from src.backend.cad.snapping import polygon_centroid as _polygon_centroid
...
def _connected_poly_ids(self, start_id: str) -> set[str]:
    ...
    id_to_idx: dict[str, int] = {e.id: i for i, e in enumerate(entities)}
