...
class MultiPasteDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        self.setWindowTitle("Paste Multiple")
        ...
        layout.addRow("Offset", self.distance_input)
        layout.addRow("Copies", self.count_input)
        layout.addRow("Direction", self.direction_input)
    ...
    def values(self) -> tuple[float, int, tuple[float, float]]:
        ...
        return self.distance_input.value(), self.count_input.value(), vectors[self.direction_input.currentText()]
