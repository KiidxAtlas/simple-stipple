...
can be shown/hidden and reordered — see ``src.ui.widgets.dialogs.settings_dialog``'s
...
from src.ui.widgets.controls.cycle_icon_button import CycleIconButton, StateEntry
