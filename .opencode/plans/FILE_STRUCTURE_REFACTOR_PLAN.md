...
| `src/simple_stipple/canvas/operations/*` | `src/simple_stipple/canvas/core/operations/*` (logic) <br> `src/simple_stipple/canvas/ui/services/*` (UI) | Separate interaction services from core operations. | High |
...
- Perform a dry run of `pytest` after every sub-phase.
